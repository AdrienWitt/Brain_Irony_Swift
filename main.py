...
def cli_main():
    ...
    parser.add_argument("--project_name", default="Brain-DeepLearning", type=str, help="A name of project (Neptune)")
    ...
    elif args.loggername == "csvlogger":
    ...
    if args.grad_clip:
        ...
        print("Sanity validation steps:", trainer.num_sanity_val_steps)
